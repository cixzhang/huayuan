...
export const DIALOG_POOL: DialogTree[] = [
  ...
  // --- Garden assessment ---
  {
    ...
    options: [
      { text: '', pinyin: '', english: 'Garden', isCorrect: true },
      { text: '', pinyin: '', english: 'School', isCorrect: false },
      { text: '', pinyin: '', english: 'Kitchen', isCorrect: false },
    ],
  ...
  },
  {
    ...
    question: { text: '"新的一天"是什么意思？', pinyin: '"xīn de yītiān" shì shénme yìsi?' },
    options: [
      { text: '', pinyin: '', english: 'A new day', isCorrect: true },
      { text: '', pinyin: '', english: 'A long night', isCorrect: false },
      { text: '', pinyin: '', english: 'A big garden', isCorrect: false },
    ],
  ...
  },
  {
    ...
    options: [
      { text: '', pinyin: '', english: 'Imbalance', isCorrect: false },
      { text: '', pinyin: '', english: 'Balance', isCorrect: true },
      { text: '', pinyin: '', english: 'Confusion', isCorrect: false },
    ],
